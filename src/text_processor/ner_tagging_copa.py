...
def tagging(dataset, nlp, output_path):
    ...
    for line in dataset:
        ...
        for i in range(2):
            choice_tag = "choice" + str(i + 1)
            answer = line[choice_tag]
            ...
            line[choice_tag + "_entities"] = answer_entities
    ...
    logger.info('In total, {} contexts and {} questions and {} answers are skipped...'.format(skip_context_cnt,
                                                                                              skip_question_cnt,
                                                                                              skip_answer_cnt))
